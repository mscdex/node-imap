...
function ImapConnection(options) {
  ...
  if (!options.hasOwnProperty('xoauth') && (options.hasOwnProperty('xoauthSettings'))) {
      var oauth = require('./xoauth');
      this._options.xoauth = oauth.XOAuthGenerator(options.xoauthSettings);
  }
