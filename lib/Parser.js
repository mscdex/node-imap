...
Parser.prototype.try_emit_error = function(err){
...
Parser.prototype._tryread = function(n) {
  ...
  dom.run(function(){
    try {
      ...
      //console.error('Parsers try_read catched', err, new Date());
      this.try_emit_error(err);
    }
  }.bind(this));
  dom.on('error', function(err){
    //console.error('Parsers try_read error', err, new Date());
    this.try_emit_error(err);
  }.bind(this));
};
